...
for nfold = 1 : 5
    ...
    for fold=1:nruns
        ...
        for i=1:batch_size:size(train,1)
            ...
            [post_u, iter, test_aucs, time_stat] = POST(post_u,batch_data,opt, test);
            vi.time_stat{l, nfold} = cumsum(time_stat);
            vi.test_auc_stat{l,nfold} = test_aucs;
...
save('vi-binary-performance.mat', 'vi');
diary off
