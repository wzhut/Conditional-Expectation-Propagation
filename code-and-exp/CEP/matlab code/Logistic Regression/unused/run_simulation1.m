...
load('./simulation/simulation1.mat', 'train', 'test', 'ts_mean', 'ts_var');
...
cep2.auc = aucs;
cep2.time = time;
save('./simulation1.mat', 'cep2', '-append');
...
ep.auc = aucs;
ep.time = time;
save('./simulation1.mat', 'ep', '-append');
...
epv2.auc = aucs;
epv2.time = time;
save('./simulation1.mat', 'epv2', '-append');
...
epnf.auc = aucs;
epnf.time = time;
save('./simulation1.mat', 'epnf', '-append');
...
vb.auc = aucs;
vb.time = time;
save('./simulation1.mat', 'vb', '-append');
...
vbnf.auc = aucs;
vbnf.time = time;
save('./simulation1.mat', 'vbnf', '-append');
...
% lp.auc = aucs;
% lp.time = time;
% save('./simulation1.mat', 'lp', '-append');
% 
% % LP nf
...
% lpnf.auc = aucs;
% lpnf.time = time;
% save('./simulation1.mat', 'lpnf', '-append');
