...
for i = 1 : num_dataset
    ...
    for j = 1 : num_run
        ...
        epv2_size(j) = size(epv2.lls{i,j}, 2);
    ...
    for j = 1: num_run
        ...
        epv2_data(j,1:epv2_size(j)) = epv2.lls{i,j};
        epv2_data(j,setdiff(1:epv2_length, 1:epv2_size(j))) = epv2.lls{i,j}(end);
    ...
    plot(1:epv2_length, epv2_data, 'b', 'LineWidth',3);
